...
import { setLoginModal, setUser } from "../../redux/slices/slices";
import { LoginModal } from "../modalElem/component";
        ...
        {token ? (
          <>
            <div className={classNames(styles.user_boxicon_div)}>
              <img
                className={classNames(styles.user_icon)}
                src={userIcon}
                alt="user icon"
              />
            </div>
            <button
              ...
              className={classNames(styles.logout_btn)}>
              Выйти
            </button>
          </>
        ) : (
          <button
            ...
            className={classNames(styles.login_btn)}>
            Войти
          </button>
        )}
      </div>
