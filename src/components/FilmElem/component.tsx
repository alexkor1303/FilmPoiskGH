...
import { Rating } from "../RatingElem/component";
...
export const Film: ({
  ...
  film: FilmT;
  user: boolean;
}) => JSX.Element = ({ film, user }: { film: FilmT; user: boolean }) => {
      ...
      <div className={classNames(styles.right_box)}>
        <div className={classNames(styles.main)}>
          ...
          <div className={classNames(styles.grid)}>
            ...
            <p className={classNames(styles.release_year_v)}>
              {film.release_year}
            </p>
            <p className={classNames(styles.description)}>Описание</p>
            <p className={classNames(styles.description_v)}>
              {film.description}
            </p>
          </div>
        </div>
