...
import { Pagination } from "../PaginationElem/component";
import { Film } from "../FilmElem/component";
import { FilmT } from "../../types/types";
import { Loading } from "../LoadingElem/component";
...
export const Films = () => {
  ...
  const {
    search_result: films,
    total_pages,
  }: { search_result: FilmT[]; total_pages: number } = useAppSelector(
